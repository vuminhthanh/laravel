    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Slider Biên tập</h1>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Slider Iamge</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"name="slider_name" value="{{$slider->slider_name}}" class="form-control" placeholder="Tiêu đề">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Slider Url</label>
                                        <input type="text" name="slider_url" value="{{$slider->slider_url}}" class="form-control" placeholder="Slider Url ">
                                    </div>

                                    <div class="form-group">
                                        <label for="">Slider Hiển thị</label><br>
                                        <input type="checkbox" name="slider_status" {{$slider->slider_status == 'on' ? 'checked' : ' '}} data-bootstrap-switch>
                                    </div>
                                </div>

                                <div class="card-footer">
                                    <button id="slidersButton" type="button" class="btn btn-primary">Tạo</button>
                                </div>
                            </div>
                        </div>
                    </div>

    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card direct-chat direct-chat-warning collapsed-card">
                            <div class="card-header">
                                <h3 class="card-title">Thêm cài đặt trang web</h3>
                                        ...
                                        <div class="form-group row col-md-11">
                                            ...
                                            <div class="col-md-3">
                                                <button id="settingsButton" type="button"
                                                        class="btn btn-primary btn-block"> Tạo
                                                </button>
                                            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Danh sách Cài đặt Trang web</h3>
                    </div>
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($settings as $setting)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('setting-edit',$setting->id)}}" class="btn btn-primary"><i class="fas fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                        <button class="btn btn-danger" onclick="deleteSettings(this,'{{$setting->id}}')"><i class="fas fa-trash-alt"></i>&nbsp;Xóa</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>

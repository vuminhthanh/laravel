                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="blog_title"  value="{{$blog->blog_title}}" class="form-control" placeholder="Tiêu đề">
                                    </div>
{{--                                    <div class="form-group">--}}
...
{{--                                    </div>--}}
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input type="text" name="blog_description"  value="{{$blog->blog_description}}" class="form-control" placeholder="Mô tả ngắn gọn">
                                    </div>
{{--                                    <div class="form-group">--}}
{{--                                        <label for="exampleInputEmail1">Tag</label>--}}
{{--                                        <input type="text" name="blog_tags"  value="{{$blog->blog_tags}}" class="form-control" placeholder="Tag">--}}
{{--                                    </div>--}}
                                    <div class="form-group">

...
{{--                                    <td>{{$blog->blog_content}}</td>--}}
                                    ...
                                    <td>
                                        <a href="{{route('blog-edit',$blog->id)}}" class="btn btn-primary"><i class="fas fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                        <button class="btn btn-danger" onclick="deleteBlogs(this,'{{$blog->id}}')"><i class="fas fa-trash-alt"></i>&nbsp;Xóa</button>

                                        @if($blog->blog_status == 'on')
                                            <button class="btn btn-success" onclick="blogsStatus(this,'{{$blog->id}}','off')"><i class="fas fa-eye-slash">off</i></button>
                                        @else
                                            <button class="btn btn-success" onclick="blogsStatus(this,'{{$blog->id}}','on')"><i class="fas fa-eye"></i>on</button>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach

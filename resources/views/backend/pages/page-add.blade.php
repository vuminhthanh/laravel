                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="page_name" class="form-control" placeholder="Tiêu đề">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Mô tả ngắn</label>
                                        <input type="text" name="page_description" class="form-control" placeholder="Mô tả ngắn">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Tag</label>
                                        <input type="text" name="page_tags" class="form-control" placeholder="Tag">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="card-footer">
                                    <button id="pageButton" type="button" class="btn btn-primary">Tạo</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Hình ảnh trang</h3>
                                </div>
                                <br>
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">hiển thị trang</h3>
                                </div>
                                <br>
                                <div class="card-body">
                                    <div class="form-group">
